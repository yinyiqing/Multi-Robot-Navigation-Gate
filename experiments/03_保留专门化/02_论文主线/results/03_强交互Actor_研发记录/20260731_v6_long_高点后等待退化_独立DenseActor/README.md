...
epoch-11随后在固定200场Dense monitor上与5A完成同序配对验证。v6的full success从5A的`0.335`提高到`0.445`，说明中期收益真实；但同时产生`0.120` timeout，平均步数从`26.96`增至`69.77`，仍未通过独立Dense Actor验收。

完整结果见相邻目录`20260731_v6_epoch11_固定200场配对复核`。
