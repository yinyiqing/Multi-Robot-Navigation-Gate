...
状态：`epoch-16完整训练状态分叉pilot运行中；离线蒸馏与D2b fresh Critic已拒绝`。
...
5. Critic沿用修正后的每联合环境步更新口径，Actor解冻前必须先通过同状态反事实校准。
...
- 第1-2天：冻结本协议，完成Critic校准和epoch-16 warm-start短pilot。
- 第3-5天：仅对通过趋势的配置训练并做50/200场复核。
