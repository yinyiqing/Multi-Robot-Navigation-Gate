...
本目录按研究演进归档。历史目录中的“当前主线”和“下一步”只代表当时判断；跨阶段的当前结论只以 [`04_保留专门化/05_论文主线/README.md`](04_保留专门化/05_论文主线/README.md) 为准。
...
| `04_保留专门化/04_安全兜底/` | `planned` | 暂停；不属于当前 D5-G0 工作 |
...
1. [实验总览](实验总览.md)
2. [论文主线](04_保留专门化/05_论文主线/README.md)
3. [数据集索引](04_保留专门化/05_论文主线/datasets/README.md)
4. [结果索引](04_保留专门化/05_论文主线/results/README.md)
5. [现有场景对照](04_保留专门化/05_论文主线/SCENARIO_COMPARISON.md)
...
- `05_论文主线/results/` 的新实验必须先按用途进入编号父目录，禁止恢复平铺结构。
