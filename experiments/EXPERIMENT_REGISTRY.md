...
| `G12-R2-S2` | `current registered baseline` | 从S0 best进入两车完整broad训练，首段2x10k | 当前方法Actor被更新或已获得五车成绩 |
...
| 参数匹配单Actor容量对照 | [`12_参数匹配单Actor容量对照`](03_保留专门化/02_论文主线/12_参数匹配单Actor容量对照/README.md) | `R2-S1 rejected / R2-S2 n2 current` | S0保留，repair候选回滚；当前直接训练两车完整broad首段20k |
