...
| `deployable interaction Gate` | `current / G11-C pilot passed` | B2在两个50场仿真重复中均超过A1，保留student聚合并进入训练seed复核 | 已通过最终准入、统计显著或可以读取部署期真值 |
...
| 可部署在线Gate新路线 | [`11_可部署在线Gate研究`](03_保留专门化/02_论文主线/11_可部署在线Gate研究/README.md) | `current / G11-C pilot passed` | B2通过保留判断；当前做G11-D训练seed复核与独立准入，Actor冻结 |
