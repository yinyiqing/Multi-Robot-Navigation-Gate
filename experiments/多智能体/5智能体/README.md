...
五车共享 Policy baseline、RewardOnly、Weighted08、D2 几何邻域 Critic + Weighted08 和 E 纯几何邻域 Critic 已完成训练和 300 episodes 测试。该规模用于检验三车实验中表现较好的设置在机器人数量增加后是否仍然稳定。
...
当前 A/B/C/D2/E 已补齐，可用于判断五车 D2 下降主要来自 reward 设计还是 critic 结构。
