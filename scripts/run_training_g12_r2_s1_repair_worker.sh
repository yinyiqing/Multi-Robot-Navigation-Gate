...
export DRL_MULTI_CURRICULUM_CASES="$CASE_FILE"
...
export DRL_MULTI_TRAINING_VERSION=g12-r2-s1-repair-n1-pilot-v1
...
export DRL_MULTI_LOCAL_NAV_HEADING_WEIGHT=0.35
export DRL_MULTI_LOCAL_NAV_WRONG_WAY_PENALTY=0.25
export DRL_MULTI_LOCAL_NAV_TURN_WEIGHT=0.22
export DRL_MULTI_LOCAL_NAV_NEAR_GOAL_DISTANCE=0.9
export DRL_MULTI_LOCAL_NAV_HEADING_ERROR=0.5
export DRL_MULTI_USE_WALL_CLEARANCE_REWARD=1
export DRL_MULTI_WALL_CLEARANCE_SAFE_DISTANCE=0.55
export DRL_MULTI_WALL_CLEARANCE_PENALTY=0.7
export DRL_MULTI_WALL_CLEARANCE_SPEED_WEIGHT=0.9
export DRL_MULTI_WALL_CLEARANCE_TURN_WEIGHT=0.25
...
export DRL_MULTI_ACTOR_LR=0.00006
...
export DRL_MULTI_EXPL_MIN=0.025
...
echo "Starting G12-R2-S1 repair pilot"
echo "Model: $MODEL_NAME"
echo "Warm start: $LOAD_MODEL (Actor and Critic)"
echo "Budget: 20000 agent samples"
echo "Repair cases: $CASE_FILE"
echo "Broad validation: $EVAL_MANIFEST"
echo "Training log: $TRAIN_LOG"

cd "$TD3_DIR"
python3 -u train_velodyne_td3_multi.py >>"$TRAIN_LOG" 2>&1
echo "G12-R2-S1 repair pilot complete."
