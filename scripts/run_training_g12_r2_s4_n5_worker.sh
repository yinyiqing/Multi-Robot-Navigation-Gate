...
export DRL_MULTI_SEED=20260816
...
export DRL_MULTI_TRAINING_VERSION=g12-r2-s4-wide-n5-pilot-v1
...
echo "Starting G12-R2-S4 five-robot pilot"
...
echo "G12-R2-S4 five-robot pilot complete."
