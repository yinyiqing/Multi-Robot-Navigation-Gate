...
LOG_DIR="${DRL_MULTI_LOG_DIR:-$PROJECT_ROOT/logs}"
...
ACTOR_HIDDEN_DIM_1="${DRL_MULTI_ACTOR_HIDDEN_DIM_1:-800}"
ACTOR_HIDDEN_DIM_2="${DRL_MULTI_ACTOR_HIDDEN_DIM_2:-600}"
ALLOW_ACTOR_EXPANSION="${DRL_MULTI_ALLOW_ACTOR_WARMSTART_EXPANSION:-0}"
EARLY_STOP_PATIENCE="${DRL_MULTI_EARLY_STOP_PATIENCE:-0}"
EARLY_STOP_MIN_EPOCHS="${DRL_MULTI_EARLY_STOP_MIN_EPOCHS:-0}"
EARLY_STOP_FULL_DROP="${DRL_MULTI_EARLY_STOP_FULL_SUCCESS_DROP:-0}"
EARLY_STOP_SUCCESS_DROP="${DRL_MULTI_EARLY_STOP_SUCCESS_DROP:-0}"
EARLY_STOP_TIMEOUT_INCREASE="${DRL_MULTI_EARLY_STOP_TIMEOUT_INCREASE:-1}"
EARLY_STOP_TIMEOUT_ABSOLUTE="${DRL_MULTI_EARLY_STOP_TIMEOUT_ABSOLUTE:-}"
...
[[ "$ACTOR_HIDDEN_DIM_1" =~ ^[1-9][0-9]*$ ]] || {
  echo "DRL_MULTI_ACTOR_HIDDEN_DIM_1 must be positive"
  exit 2
}
[[ "$ACTOR_HIDDEN_DIM_2" =~ ^[1-9][0-9]*$ ]] || {
  echo "DRL_MULTI_ACTOR_HIDDEN_DIM_2 must be positive"
  exit 2
}
[[ "$ALLOW_ACTOR_EXPANSION" == 0 || "$ALLOW_ACTOR_EXPANSION" == 1 ]] || {
  echo "DRL_MULTI_ALLOW_ACTOR_WARMSTART_EXPANSION must be 0 or 1"
  exit 2
}
...
setsid bash -lc "
  ...
  export DRL_MULTI_EARLY_STOP_PATIENCE='$EARLY_STOP_PATIENCE'
  export DRL_MULTI_EARLY_STOP_MIN_EPOCHS='$EARLY_STOP_MIN_EPOCHS'
  export DRL_MULTI_EARLY_STOP_FULL_SUCCESS_DROP='$EARLY_STOP_FULL_DROP'
  export DRL_MULTI_EARLY_STOP_SUCCESS_DROP='$EARLY_STOP_SUCCESS_DROP'
  export DRL_MULTI_EARLY_STOP_TIMEOUT_INCREASE='$EARLY_STOP_TIMEOUT_INCREASE'
  if [[ -n '$EARLY_STOP_TIMEOUT_ABSOLUTE' ]]; then
    export DRL_MULTI_EARLY_STOP_TIMEOUT_ABSOLUTE='$EARLY_STOP_TIMEOUT_ABSOLUTE'
  else
    unset DRL_MULTI_EARLY_STOP_TIMEOUT_ABSOLUTE
  fi

  export DRL_MULTI_ACTOR_TRAIN_MODE=full
  export DRL_MULTI_ACTOR_HIDDEN_DIM_1='$ACTOR_HIDDEN_DIM_1'
  export DRL_MULTI_ACTOR_HIDDEN_DIM_2='$ACTOR_HIDDEN_DIM_2'
  export DRL_MULTI_ALLOW_ACTOR_WARMSTART_EXPANSION='$ALLOW_ACTOR_EXPANSION'
...
echo "Actor architecture: 24->$ACTOR_HIDDEN_DIM_1->$ACTOR_HIDDEN_DIM_2->2 expansion=$ALLOW_ACTOR_EXPANSION"
...
echo "Early stop: patience=$EARLY_STOP_PATIENCE min_epochs=$EARLY_STOP_MIN_EPOCHS full_drop=$EARLY_STOP_FULL_DROP success_drop=$EARLY_STOP_SUCCESS_DROP timeout_increase=$EARLY_STOP_TIMEOUT_INCREASE timeout_absolute=${EARLY_STOP_TIMEOUT_ABSOLUTE:-disabled}"
echo "Log: $log_file"
