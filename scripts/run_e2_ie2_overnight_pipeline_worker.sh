...
N5_MANIFEST="$VIEW_DIR/g12_r2_curriculum_v1/n5/validation.json.gz"
STRONG_TRAIN="$VIEW_DIR/strong_interaction_curriculum_v1/full_train.json.gz"
STRONG_VALIDATION="$VIEW_DIR/strong_interaction_curriculum_v1/validation.json.gz"
ROUTE_DIR="$PROJECT_ROOT/experiments/03_保留专门化/02_论文主线/15_E2恢复Actor诊断与训练"
RUN_DIR="$ROUTE_DIR/local_data/e2_ie2_overnight_pipeline"
...
IE2_MODEL="interaction_recovery_from_e2_strong40k_s20260820"
...
run_ie2_training() {
  ...
  for attempt in $(seq 1 3); do
    ...
    (
      ...
      export DRL_MULTI_TRAINING_VERSION=e2-interaction-specialist-40k-pilot-v1
