...
SAFE_RECOVERY_ROBOT_DISTANCE="${IE2_SAFE_RECOVERY_ROBOT_DISTANCE:-1.2}"
ACTOR_SAFETY_FOCUSED="${IE2_ACTOR_SAFETY_FOCUSED:-1}"
ACTOR_SAFETY_DISTANCE="${IE2_ACTOR_SAFETY_DISTANCE:-1.0}"
ACTOR_SAFETY_MIN_CLOSING_SPEED="${IE2_ACTOR_SAFETY_MIN_CLOSING_SPEED:-0.1}"
ACTOR_UPDATE_DELAY="${IE2_ACTOR_UPDATE_DELAY_STEPS:-21000}"
...
# The evaluator accepts an absolute generated launch file. Keep it inside the
# active run directory so each isolated pilot owns its ROS/Gazebo configuration.
...
run_ie2_training() {
  ...
  for attempt in $(seq 1 3); do
    ...
    (
      ...
      export DRL_MULTI_SAFE_RECOVERY_ROBOT_DISTANCE="$SAFE_RECOVERY_ROBOT_DISTANCE"
      ...
      export DRL_MULTI_ACTOR_SAFETY_FOCUSED="$ACTOR_SAFETY_FOCUSED"
      export DRL_MULTI_ACTOR_SAFETY_CANDIDATE_BATCH_SIZE=256
      export DRL_MULTI_ACTOR_SAFETY_MIN_SAMPLES=16
      export DRL_MULTI_ACTOR_SAFETY_DISTANCE="$ACTOR_SAFETY_DISTANCE"
      export DRL_MULTI_ACTOR_SAFETY_MIN_CLOSING_SPEED="$ACTOR_SAFETY_MIN_CLOSING_SPEED"
