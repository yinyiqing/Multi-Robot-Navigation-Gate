...
export DRL_MULTI_TEST_TARGET_EPISODES=50 DRL_MULTI_STANDARD_ACTOR_FILE="$R2_MODEL"
export DRL_MULTI_TEST_ACTOR_MODE=full DRL_MULTI_ACTOR_SELECTION_MODE=single
...
run_one() {
  local repeat="$1" seed="$2" run="g11_f_c_r2_r${1}_s${2}"
...
run_one 1 20260805
run_one 2 20260806
/usr/bin/python3 "$ROOT/scripts/analyze_g11_f_epoch17_r2_pilot.py" >"$LOG_DIR/analysis.log" 2>&1
