...
setsid bash -lc "
  ...
  export DRL_MULTI_YIELD_PRIORITY_PENALTY_WEIGHT=4.0
  export DRL_MULTI_YIELD_PRIORITY_BONUS_WEIGHT=0.4
  export DRL_MULTI_YIELD_PRIORITY_CLEARANCE_BONUS_WEIGHT=1.0
  export DRL_MULTI_YIELD_PRIORITY_RESTART_BONUS_WEIGHT=3.0
  export DRL_MULTI_YIELD_PRIORITY_STALE_WAIT_PENALTY_WEIGHT=0.8
  export DRL_MULTI_YIELD_PRIORITY_MAX_WAIT_STEPS=4
  export DRL_MULTI_EMERGENCY_STOP_DISTANCE=0.6
  export DRL_MULTI_EMERGENCY_STOP_PENALTY_WEIGHT=8.0
  export DRL_MULTI_EMERGENCY_STOP_BONUS_WEIGHT=1.0
  ...
  export DRL_MULTI_SAFE_RECOVERY_PENALTY=0.2
