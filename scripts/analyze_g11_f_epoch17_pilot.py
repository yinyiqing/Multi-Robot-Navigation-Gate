...
ACTIVE_LOG_DIR = ROOT / "logs/active/g11_f_epoch17_gate_pilot"
ARCHIVE_LOG_DIR = ROOT / "logs/archive/validation/g11_f_epoch17_gate_pilot"
POLICIES = ("5a", "a1", "b2")
...
def main():
    ...
    summary = {
        ...
        "paired": {
            ...
            "b2_vs_5a": paired(combined["b2"], combined["5a"]),
    ...
    output = RUN_DIR / "local_data/pilot/summary.json"
