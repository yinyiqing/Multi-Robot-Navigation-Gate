...
export DRL_MULTI_SEED=20260814
...
export DRL_MULTI_TRAINING_VERSION=g12-r2-s2-wide-n2-pilot-v1
...
echo "Starting G12-R2-S2 two-robot pilot"
...
echo "G12-R2-S2 two-robot pilot complete."
