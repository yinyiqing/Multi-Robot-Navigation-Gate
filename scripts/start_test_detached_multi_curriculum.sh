...
case "$STAGE" in
  ...
  *)
    ...
    echo "Available stages: stage1_single, stage1b_single, stage1b_hard_only, stage1c_wall_clearance, stage1d_wall_feasible, stage1e_single_rescue, stage2_three_dense, stage2_dense"
    exit 1
    ;;
esac
