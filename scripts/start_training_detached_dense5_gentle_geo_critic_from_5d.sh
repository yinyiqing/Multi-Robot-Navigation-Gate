...
export DRL_MULTI_REWARD_SELF_WEIGHT="${DRL_MULTI_REWARD_SELF_WEIGHT:-0.82}"
export DRL_MULTI_USE_DISTANCE_WEIGHTED_REWARD=1
export DRL_MULTI_USE_LOCAL_NAVIGATION_REWARD=0
export DRL_MULTI_INTERACTION_SAFE_DISTANCE="${DRL_MULTI_INTERACTION_SAFE_DISTANCE:-0.95}"
export DRL_MULTI_INTERACTION_CLOSE_PENALTY="${DRL_MULTI_INTERACTION_CLOSE_PENALTY:-0.55}"
