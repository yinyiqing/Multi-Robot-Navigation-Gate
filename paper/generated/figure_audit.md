...
- Quantitative plots are editable SVG with embedded text and explicit Arial fallback.
...
- `scipilot-figure-skill/scripts/check_figure.py`: PASS for all four SVG artifacts.
